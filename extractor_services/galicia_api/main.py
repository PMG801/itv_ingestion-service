"""
API Extractora de Galicia
Microservicio para extracción y transformación de datos de ITVs de Galicia
"""
import sys
import os
...
from extractor import GaliciaExtractorService

# Configuración
settings = GaliciaSettings()
...
extractor_service = GaliciaExtractorService()
...
app = FastAPI(
    ...
    description="Microservicio para extracción de datos de ITVs de Galicia",
    lifespan=lifespan
)
