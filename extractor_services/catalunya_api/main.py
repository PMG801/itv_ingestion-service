"""
API Extractora de Catalunya
Microservicio para extracción y transformación de datos de ITVs de Catalunya
"""
import sys
import os
...
from extractor import CatalunyaExtractorService

# Configuración
settings = CatalunyaSettings()
...
extractor_service = CatalunyaExtractorService()
...
app = FastAPI(
    ...
    description="Microservicio para extracción de datos de ITVs de Catalunya",
    lifespan=lifespan
)
